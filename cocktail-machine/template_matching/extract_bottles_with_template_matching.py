...
tanqueray_bottle = img[tanqueray_location[1]:tanqueray_location[1]+tanqueray_height, tanqueray_location[0]:tanqueray_location[0] + tanqueray_width]
cv2.imwrite('../../images/template-matching-tanqueray-crop.png',tanqueray_bottle)

# is_bottle_full("../../images/template-matching-martini-crop.png")
is_bottle_full("../../images/template-matching-bitterol-crop.png")
is_bottle_full("../../images/template-matching-tanqueray-crop.png")
